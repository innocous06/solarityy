...
const CostBreakdown = ({ systemCost, subsidy }) => {
  ...
  return (
    <div className="bg-white p-8 rounded-[2.5rem] shadow-sm">
      <div className="mb-6">
        <h3 className="text-2xl font-black text-gray-900 mb-2">Cost Breakdown</h3>
        <p className="text-gray-500 text-sm">System installation cost distribution</p>
      </div>
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="flex items-center justify-between p-4 bg-green-100 rounded-xl border-2 border-green-500 mt-4">
          <span className="text-sm font-bold text-green-800">Government Subsidy (20%)</span>
          <span className="text-lg font-black text-green-600">-₹{subsidy.toLocaleString()}</span>
        </div>
      </div>
    </div>
  );
